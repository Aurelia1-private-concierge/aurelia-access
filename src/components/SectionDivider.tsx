...
const SectionDivider = forwardRef<HTMLDivElement, SectionDividerProps>(({
  ...
  if (variant === "wide") {
    return <div ref={ref} className={cn("py-12", className)}>
  ...
  if (variant === "ornate") {
    return <div ref={ref} className={cn("py-16 flex items-center justify-center", className)}>
          <div className="gap-4 items-center justify-center flex flex-col text-destructive">
            <div className="w-16 h-px bg-gradient-to-r from-transparent to-border/30" />
            <div className="w-1.5 h-1.5 rounded-full bg-primary/30 text-gold" />
            <div className="w-16 h-px bg-gradient-to-l from-transparent to-border/30" />
          </div>
        </div>;
  }
  return <div ref={ref} className={cn("py-10", className)}>
        <div className="max-w-7xl mx-auto px-6">
          <div className="h-px bg-gradient-to-r from-transparent via-border/20 to-transparent" />
        </div>
      </div>;
