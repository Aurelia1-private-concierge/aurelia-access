...
const testimonials = [
  ...
  },
  {
    ...
    author: "James K.",
    title: "Tech Executive, Singapore",
    image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=200&auto=format&fit=crop",
  },
  {
    quote: "The discretion is absolute. In my position, that's not a luxury—it's a necessity. Aurelia understands this implicitly.",
    author: "Victoria S.",
    title: "Family Office Principal, London",
...
const TestimonialsSection = () => {
  ...
  return (
    <section ref={ref} className="py-24 bg-background relative overflow-hidden">
      ...
      <motion.div
        style={{ x: glowX }}
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[1000px] h-[600px] bg-primary/3 blur-[200px] rounded-full pointer-events-none"
      />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="font-serif text-4xl md:text-5xl text-foreground tracking-tight">
            Trusted by the <span className="italic text-muted-foreground">Exceptional</span>
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="group relative p-8 bg-secondary/20 border border-border/20 backdrop-blur-sm hover:border-primary/30 hover:bg-secondary/30 transition-all duration-500 card-hover"
            >
              {/* Quote icon */}
