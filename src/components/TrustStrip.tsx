...
const partners = [
  { name: "Forbes", category: "Wealth" },
  { name: "Bloomberg", category: "Markets" },
  { name: "Robb Report", category: "Luxury" },
  { name: "Tatler", category: "Society" },
  { name: "Financial Times", category: "Global" },
  { name: "Monocle", category: "Culture" },
];
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16">
          {partners.map((partner, index) => (
            ...
            >
              <span 
                className="text-lg md:text-xl tracking-[0.15em] text-muted-foreground/30 group-hover:text-muted-foreground/60 transition-colors duration-500"
