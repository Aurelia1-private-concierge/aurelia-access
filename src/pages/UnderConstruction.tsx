...
import { 
  ...
  Bot, Clock, Zap, Diamond, HeartHandshake, Lock, Youtube
} from "lucide-react";
...
const socialLinks = [
  ...
  { icon: TikTokIcon, href: "/tiktok", label: "TikTok", color: "hover:text-foreground", isInternal: true },
  { icon: Youtube, href: "/youtube", label: "YouTube", color: "hover:text-red-500", isInternal: true },
];
